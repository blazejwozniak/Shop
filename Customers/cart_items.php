...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li  class="active"><a href="cart_items.php"> &nbsp; <span class='fa fa-cart-plus'></span> Koszyk</a></li>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="fa fa-cart-plus"></span> Koszyk</h3></center>
        </div>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
			...
			?>
                <tr>
				 ...
				 <td>
                  ...
                  <a class="btn btn-block btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click for delete" onclick="return confirm('Jesteś pewny, że chcesz usunąć tą rzecz?')"><span class='glyphicon glyphicon-trash'></span> Usuń Przedmiot</a>
		...
		echo "<td>";
		echo "<a class='btn btn-block btn-success' href='?update_id=".$user_id."' ><span class='glyphicon glyphicon-shopping-cart'></span> Zamów</a>";
		echo "</td>";
