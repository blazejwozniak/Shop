    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Poprzednio zamówione rzeczy</strong> </h3></center>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "<tr>";
		echo "<td colspan='4' align='center' style='font-size:18px;'>"."Dane Użytkownika: <span style='color:red;'>".$user_firstname." ".$user_lastname."</span> | "."Email: <span style='color:red;'>".$user_email."</span> | "."Adres: <span style='color:red;'>".$user_address." </span>";
		echo "</td>";
		
		echo "<td>"."<a class='btn btn-danger' href='customers.php'><span class='glyphicon glyphicon-backward'></span> Wstecz<a/>";
		echo "</td>";
	...
	else
	{
        ...
        <div class="col-xs-12">
        	<div class="alert alert-warning">
            	<span class="glyphicon glyphicon-info-sign"></span> &nbsp; Nie ma jeszcze żadnych zamówień
            </div>
        </div>
        <?php
	}
