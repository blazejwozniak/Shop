    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a href="items.php"> &nbsp; &nbsp; &nbsp; Zarządzanie Asortymentem</a></li>
					<li class="active"><a href="customers.php"> &nbsp; &nbsp; &nbsp; Użytkownicy</a></li>
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Użytkownicy</strong> </h3></center>
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                <tr>
				 ...
				 <a class="btn btn-success" href="view_orders.php?view_id=<?php echo $row['user_id']; ?>"><span class='glyphicon glyphicon-shopping-cart'></span> Zobacz Zamówienia</a>
				  <a class="btn btn-warning" href="?order_id=<?php echo $row['user_id']; ?>" title="click for delete" onclick="return confirm('Czy napewno chcesz zresetować zamówienie klienta?')">
				  <span class='glyphicon glyphicon-ban-circle'></span>
				  Zresetuj Zamówienie</a>
				 <a class="btn btn-primary" href="previous_orders.php?previous_id=<?php echo $row['user_id']; ?>"><span class='glyphicon glyphicon-eye-open'></span> Poprzednie Zamówienia</a>
				
				
                  <a class="btn btn-danger" href="?delete_id=<?php echo $row['user_id']; ?>" title="click for delete" onclick="return confirm('Czy jestes pewien, że chcesz usunąc tego użytkownika')">
	...
	else
	{
        ...
        <div class="col-xs-12">
        	<div class="alert alert-warning">
            	<span class="glyphicon glyphicon-info-sign"></span> &nbsp; Nie znaleziono ...
            </div>
        </div>
        <?php
	}
